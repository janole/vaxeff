...
} = {})
{
    ...
    const xAxis = d3.axisTop(xScale).tickFormat(xFormat);
    const yAxis = d3.axisLeft(yScale).tickSize(0).tickFormat(yFormat);
    ...
    svg.append("g")
        ...
        .call(g => g.append("a")
            .attr("xlink:href", "https://github.com/janole/vaxeff/")
            .append("text")
